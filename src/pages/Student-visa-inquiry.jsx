...
export default function Studentvisainquiry() {
  ...
  useEffect(() => {
    axios
      .get("https://goforen.com/go_foren/get_occupation_data/")
  ...
  const handleRemove = (countryToRemove) => {
    setSelectedCountries(
      selectedCountries.filter((c) => c !== countryToRemove)
    );
  };
  ...
  const [intendedStudy, setIntendedStudy] = useState([{ month: "", year: "" }]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://goforen.com/go_foren/submit_student_visa_inquiry/",
        {
          method: "POST",
          body: formData,
        }
    ...
    <div>
      ...
      >
                            ...
                            <tr key={index}>
                              ...
                              <td>
                                ...
                                >
                                  ...
                                  <option value="Gym Manager">
                                    Gym Manager
                                  </option>
                                  <option value="Hair Artist">
                                    Hair Artist
                                  </option>
        ...
        {/* {step === 7 && showSpouseDetails && (
          <DetailsAboutSpouse onNext={handleNext} onPrevious={handlePrevious} />
        )} */}
        {/* {step === 7 && !showSpouseDetails && (
          <UploadYourResume onPrevious={handlePrevious} onNext={handleNext} />
        )} */}
        ...
        {/* {step === 9 && <AdditionalDetails onPrevious={handlePrevious} />} */}
                  ...
                  <form onSubmit={handleSubmit} className="container mt-4">
                    {step1 === 1 && (
                      <div>
                        ...
                        value={form.relation} onChange={handleChange2} className="form-control" /> */}
                          </div>
                          ...
                          <div className="col-md-6">
                            ...
                            <input
                              ...
                              placeholder="Enter Spouse/Dependent Visa"
                              value={form.spouse_dependent_visa}
                              style={custom_input}
                              onChange={handleChange2}
                              className="form-control"
                            />
                    ...
                    {step1 === 5 && (
                      <div>
                        ...
                        <button
                          type="button"
                          className="btn btn-primary my-2"
                          onClick={() => handleAddRow(exams, setExams, {})}
                        >
                          + Add Exam
                        </button>
                    ...
                    {step1 === 6 && (
                      <div>
                        ...
                        <button
                          type="button"
                          className="btn btn-primary my-2"
                          onClick={() => handleAddRow(tests, setTests, {})}
                        >
                          + Add Test
                        </button>
                    ...
                    {step1 === 7 && (
                      <div>
                        ...
                        <button
                          ...
                          className="btn btn-primary my-2"
                          onClick={() =>
                            handleAddRow(intendedStudy, setIntendedStudy, {})
                          }
                        >
                          + Add Intended Study
                        </button>
                        ...
                        <div className="row mb-4">
                          <div className="col-md-6">
                            ...
                            <input
                              ...
                              placeholder="Enter Valid Passport"
                              value={form.is_valid_passport}
                              style={custom_input}
                              onChange={handleChange2}
                              className="form-control"
                            />
                          ...
                          <div className="col-md-6">
                            <label className="form-label">
                              Blood Relative Abroad (Yes/No)
                            </label>
                            <select
                              name="blood_relative_foreign"
                              value={form.blood_relative_foreign}
                              style={custom_input}
                              onChange={handleChange2}
                              className="form-select"
                            >
                          ...
                          <div className="col-md-6">
                            ...
                            <input
                              type="text"
                              name="how_about_us"
                              placeholder="How About Us..."
                              value={form.how_about_us}
                              onChange={handleChange2}
                              style={custom_input}
                              className="form-control"
                            />
